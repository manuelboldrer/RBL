...
parameters = {
        "R_circle": 10,              # If greater than 0, robots in a circle (radius of the circle).
                                       # If equal to 0, robots in a random room.
        "radius": 1.5,                 # Half of the sensing radius: dimension of the cells r_{s,i}=r_{s}.
        "xlim": (0, 12.5),             # Random room dimensions on the X-axis.
        "ylim": (0, 4.5),             # Random room dimensions on the Y-axis.
        "N": N-1,                       # Number of robots.
        ...
        "flag_plot": 0,
        "write_file": 0,
        "v_max": [random.uniform(5, 5) for _ in range(N)], # Maximum velocity for each robot
        "N_h": 0,
        "k_h": 6,
        "manual": 0,
}
